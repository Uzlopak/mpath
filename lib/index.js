...
const setTokenizeCache = require('./tokenize').setTokenizeCache;

exports.tokenize = tokenize;
exports.setTokenizeCache = setTokenizeCache;
...
exports.set = function set(path, val, o, special, map, copy, createMissing) {
  ...
  for (i = 0; i < len; ++i) {
    ...
    if (!tmp) {
      if (createMissing === true) {
        exports.set(parts.slice(i, i + 1), {}, obj, special, map, undefined, true);
        exports.set(parts.slice(i + 1), val, obj[part], special, map, undefined, true);
        return o;
      }
      return;
    }
